...
# 默认微信消息代理服务器地址
DEFAULT_WECHAT_PROXY = 'https://4khub.xyz'
# 默认OCR识别服务地址
DEFAULT_OCR_SERVER = 'https://4khub.xyz'
# 默认TMDB代理服务地址
DEFAULT_TMDB_PROXY = 'https://4khub.xyz'
# 默认CookieCloud服务地址
DEFAULT_COOKIECLOUD_SERVER = 'https://4khub.xyz:8088'
...
# 添加下载时增加的标签，开始只监控FOURKHUB添加的下载时有效
PT_TAG = "FOURKHUB"
# 电影默认命名格式
...
WEBDRIVER_PATH = {
    ...
    "Synology": "/var/packages/4khub-client/target/bin/chromedriver"
}
...
class Config(object):
    ...
    def __init__(self):
        self._config_path = os.environ.get('FKHUB_CONFIG')
    ...
    def init_config(self):
        try:
            if not self._config_path:
                print("【Config】FKHUB_CONFIG 环境变量未设置，程序无法工作，正在退出...")
                # quit()
                sys.exit(1)
