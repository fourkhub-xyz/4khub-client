...
export class LayoutNavbar extends CustomElement {
  ...
  constructor() {
    super();
    this.layout_gopage = "";
    this.layout_appversion = "v1.0";
    this.layout_userpris = navbar_list.map((item) => (item.name));
    this._active_name = "";
    this._update_appversion = "";
    this._update_url = "https://github.com/fourkhub-xyz/4khub-client";
      ...
      if (ret.code === 0) {
        ...
        switch (compareVersion(ret.version, this.layout_appversion)) {
          case 1:
            ...
            break;
          case 2:
            url = "https://github.com/fourkhub-xyz/4khub-client/commits/master"
            break;
        }
        if (url) {
          ...
          <div class="d-flex flex-row flex-grow-1 lit-navbar-hide-scrollbar">
            <div class="d-flex flex-column flex-grow-1">
              <h1 class="mt-3" style="text-align:center;">
                <img src="../static/img/logo-blue.png" alt="4KHub" class="lit-navbar-logo">
              </h1>
              ...
              <div class="d-flex align-items-end">
                ...
                <span class="d-flex flex-grow-1 justify-content-center border rounded-3 m-3 p-2 icon-pulse">
                  <a href='https://twitter.com/4khubxyz?t=w7DjRb66j1WGxGKaUkIaLQ&s=09' class="text-muted" title='加入官方Twitter，及时获取最新消息' target="_blank" rel="noreferrer">
                    <strong>
